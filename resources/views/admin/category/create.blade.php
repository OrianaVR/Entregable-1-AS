        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('category.createCategory') }}</li>
                </ol>
            </nav>
            <h2 class="lume-page-title m-0">{{ __('category.createCategory') }}</h2>
        </div>
    ...
    <div class="lume-card p-4">
        <form action="{{ route('admin.category.store') }}" method="POST">
            ...
            <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                ...
                <button type="submit" class="btn btn-primary px-4 py-2 fw-semibold">{{ __('category.createCategory') }}</button>
            </div>
        </form>
    </div>
