            ...
            <div class="col-12 col-md-8 col-lg-8 ms-auto">
                <div class="profile-card">
                    ...
                    <form action="{{ route('user.profile.update', ['id' => $viewData['user']->getId()]) }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="password" class="form-label profile-label">Password <small class="text-muted">(leave blank to keep current password)</small></label>
                            <input type="password" class="form-control profile-input" id="password" name="password" placeholder="Enter new password">
                        </div>
